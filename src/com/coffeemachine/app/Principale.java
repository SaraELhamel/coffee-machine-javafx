...
public class Principale {
	...
	public static void main(String args[]) {
		...
		// New Client
		Client client = new Client(65301248, "Ahmed Mohammed", "+212 611 11 11 11", "expresso", 10.00);
		try {
		...
		try {
			System.out.println(machineController.StartMachine(products, machine,100.0));
		} catch (Exception e) {
			// TODO Auto-generated catch block
			e.printStackTrace();
		}
